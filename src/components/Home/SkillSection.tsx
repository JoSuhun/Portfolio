  ...
  return (
    <s.SkillContainer>
      ...
      <s.SkillBox className="competent" $point="#ffdf7f">
        ...
        <s.SkillLevel className="level">다양하게 활용할 수 있는,</s.SkillLevel>
        <s.SkillItem>
          <img src={html_img} />
          <img src={css_img} />
          <div>
      ...
      <s.SkillBox className="advanced" $point="#fde69e">
        ...
        <s.SkillLevel className="level">어느정도 활용할 수 있는,</s.SkillLevel>
        <s.SkillItem>
          <img src={django_img} />
          <div>
            <p className="skill_text">Django</p>
            <p>model과 serializer을 이해하고, Rest api를 작성할 수 있습니다.</p>
          </div>
        </s.SkillItem>
        <s.SkillItem>
          <img src={vue_img} />
